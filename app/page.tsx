...
const books = [
  ...
  { zh:'深度学习理论原理', en:'The Principles of Deep Learning Theory', field:'深度学习理论', cover:asset('/covers/principles-deep-learning-theory.jpg'), original:'https://arxiv.org/abs/2106.10165', sourceLabel:'arXiv 原著', translation:asset('/pdfs/Principles_of_Deep_Learning_Theory_zh.pdf'), os:'arXiv:2106.10165v2', ts:'2.9 MB', date:'2026-08' },
  { zh:'经典与量子物理中的深度学习', en:'Deep Learning in Classical and Quantum Physics', field:'深度学习与量子物理', cover:asset('/covers/deep-learning-classical-quantum-physics.jpg'), original:'https://arxiv.org/abs/2508.10666', sourceLabel:'arXiv 原著', translation:asset('/pdfs/Deep_Learning_in_Classical_and_Quantum_Physics_zh.pdf'), os:'arXiv:2508.10666v1', ts:'27.4 MB', date:'2026-09' },
  { zh:'理解深度学习', en:'Understanding Deep Learning', field:'深度学习', cover:asset('/covers/understanding-deep-learning.jpg'), original:'https://udlbook.github.io/udlbook/', sourceLabel:'原著网站', translation:asset('/pdfs/Understanding_Deep_Learning_zh.pdf'), os:'MIT Press · 开放版本', ts:'97.8 MB', date:'2026-08' },
  { zh:'量子科学中的机器学习现代应用', en:'Modern Applications of Machine Learning in Quantum Sciences', field:'量子机器学习', cover:asset('/covers/machine-learning-quantum-sciences.jpg'), original:'https://arxiv.org/abs/2204.04198', sourceLabel:'arXiv 原著', translation:asset('/pdfs/Machine_Learning_in_Quantum_Sciences_zh.pdf'), os:'arXiv:2204.04198v4', ts:'14.6 MB', date:'2026-09' },
  { zh:'深度学习与计算物理', en:'Deep Learning and Computational Physics', field:'科学机器学习', cover:asset('/covers/deep-learning-computational-physics.jpg'), original:'https://arxiv.org/abs/2301.00942', sourceLabel:'arXiv 原著', translation:asset('/pdfs/Deep_Learning_and_Computational_Physics_zh.pdf'), os:'arXiv:2301.00942v1', ts:'7.2 MB', date:'2026-08' },
  { zh:'深度学习的数学理论', en:'Mathematical Theory of Deep Learning', field:'深度学习理论', cover:asset('/covers/mathematical-theory-deep-learning.jpg'), original:'https://arxiv.org/abs/2407.18384', sourceLabel:'arXiv 原著', translation:asset('/pdfs/Mathematical_theory_of_deep_learning_zh.pdf'), os:'arXiv:2407.18384v4', ts:'17.4 MB', date:'2026-09' },
];
